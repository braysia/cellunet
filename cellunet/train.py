...
from on_the_fly import gamma_correct, histo_match, blur


FRAC_TEST = 0.1
augment_pipe = [affine_transform(points=10, distort=2.0), random_flip(),
                random_rotate(), random_illum(perc=0.5), gamma_correct(),
                histo_match(), blur(factor=1.5)]
